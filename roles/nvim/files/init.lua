...
ToggleTermSplit = lib.create_buf_toggler(function()
...
ToggleQF = lib.create_buf_toggler(function()
...
ToggleSymbolsOutline = lib.create_buf_toggler(function()
  return utils.find_buf_with_pattern "OUTLINE"
end, function()
